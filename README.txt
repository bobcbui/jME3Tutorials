...
This is the readme for jME3Tutorials, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Jmetutorials) > Ok.
...
- To run the project find Jmetutorials.java (which will be in under src/main/java/com/ooqn) and right click > Run 'Jmetutorials'
